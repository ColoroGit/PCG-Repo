...
1. Select one of the links below to go to the project in Google Colab:<ol type="a">
     <li><a href="https://colab.research.google.com/drive/1agOQzelorvxiRExiB1Zlt2PF87gJBFLc?usp=sharing">Neural Network for classifying maps</a>.</li>
     <li><a href="https://colab.research.google.com/drive/1lzx2fOt8yN3lCafcwBS3ytNXvRnuJoLv?usp=sharing">WGAN-GP for generating maps</a>.</li>
   </ol>
